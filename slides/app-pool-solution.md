...
<svg viewBox="0 0 940 410" style="width: 100%; max-height: 420px;">
  ...
  <text x="144" y="110" text-anchor="middle" fill="#66ddaa" font-family="Roboto Mono" font-size="5" font-weight="600">Trusted reviewer</text>
  <text x="144" y="132" text-anchor="middle" fill="#e0d8d0" font-family="Roboto Mono" font-size="3.6">biomedical / DataSHIELD</text>
  <text x="144" y="154" text-anchor="middle" fill="#b0b8c0" font-family="Roboto Mono" font-size="3.5">privacy authority</text>
  ...
  <text x="800" y="110" text-anchor="middle" fill="#88ccff" font-family="Roboto Mono" font-size="4.5" font-weight="600">Hospital SuperNode</text>
  <text x="800" y="132" text-anchor="middle" fill="#e0d8d0" font-family="Roboto Mono" font-size="3.9">DataSHIELD server</text>
  <text x="800" y="154" text-anchor="middle" fill="#b0b8c0" font-family="Roboto Mono" font-size="3.5">verifies signature</text>
  ...
  <text x="474" y="389" text-anchor="middle" fill="#e0d8d0" font-family="Roboto Mono" font-size="3.8">picks the app to run</text>
  ...
  <text x="311" y="110" text-anchor="middle" fill="#66ddaa" font-family="Roboto Mono" font-size="3.3">reviews &amp; signs</text>
